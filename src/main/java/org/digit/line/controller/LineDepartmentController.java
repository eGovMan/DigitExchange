...
// import org.digit.fix.model.Individual;
...
//     private static final Logger logger = LoggerFactory.getLogger(LineDepartmentController.class);
...
//             String url = "http://127.0.0.1:8080/fix/v1/program";
...
//         BigDecimal netAmount = new BigDecimal(10);
//         BigDecimal grossAmount = new BigDecimal(10);
//         org.digit.fix.model.Disbursement bill = new Disbursement(allocation,netAmount,grossAmount);
